...
public class BookIssuedServiceImpl implements BookIssuedService{
    ...
    public BookIssuedServiceImpl(BookIssuedRepository bookIssuedRepository, UserRepository userRepository, BookRepository bookRepository, KafkaProducerService kafkaProducerService) {
